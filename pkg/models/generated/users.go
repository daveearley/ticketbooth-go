...
func (userL) LoadEvents(e boil.Executor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
...
func (o *User) AddEvents(exec boil.Executor, insert bool, related ...*Event) error {
	var err error
